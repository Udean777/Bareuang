...
fun com.ssajudn.barebudget.domain.error.AppException.toUiText(): UiText = when(this){
    is com.ssajudn.barebudget.domain.error.AppException.NetworkException -> UiText.Dyn(message ?: "Koneksi bermasalah")
    is com.ssajudn.barebudget.domain.error.AppException.AuthException -> UiText.Dyn(message ?: "Sesi berakhir")
